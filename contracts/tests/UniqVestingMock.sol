...
/// @title Uniqly vesting contract with vesting period in minutes instead of weeks for ease in testing
/// @author rav3n_pl
contract UniqVestingMock {
    ...
    */
    function claim() external returns (bool) {
        ...
        uint256 pct = 20;
        uint256 time = dateStart + 1 minutes;
        // every week to date
